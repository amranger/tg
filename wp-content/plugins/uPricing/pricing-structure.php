			...
			<div id="uds-pricing-properties">
				<table>
					...
					<?php if(!empty($pricing_table['properties'])): ?>
						<?php foreach($pricing_table['properties'] as $key => $property): ?>
						<tr>
							<td>
								<input type="text" name="labels[<?php echo $key ?>]" value="<?php echo $property['label'] ?>" />
							</td>
							<td>
								<input type="text" name="tooltips[<?php echo $key ?>]" value="<?php echo $property['tooltip'] ?>" />
							</td>
							<td>
								<select name="types[<?php echo $key ?>]">
									<option value="text" <?php if($property['type'] == 'text') echo "selected='selected'"?>>Text</option>
					...
					<tr>
						<td>
							<input type="text" name="labels[<?php echo $key?>]" value="" />
						</td>
						<td>
							<input type="text" name="tooltips[<?php echo $key?>]" value="" />
						</td>
						<td>
							<select name="types[<?php echo $key?>]">
